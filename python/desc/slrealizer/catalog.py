...
def generate_data(curr_lens, curr_obs):    
    ...
    flux_err_calc = math.pow(10, (22.5 - sky_mag)/2.5)
    ...
    first_moment_x_err_calc, first_moment_y_err_calc = PSF_HWHM / math.pow(flux/flux_err_calc, 0.5)
    ...
    RA, RA_err, DEC, DEC_err = return_coordinate(desc.slrealizer.get_first_moment_x(), desc.slrealizer.get_first_moment_y())
    ...
    I_yy += I_yy * noissify_data(desc.slrealizer.second_moment_err(), desc.slrealizer.get_second_moment_err_std())
