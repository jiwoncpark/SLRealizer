...
realizer.make_source_catalog(galsim=True, dir='../../../data/source_catalog_galsim_noise_free.csv')
realizer.make_object_catalog(source_table_dir='../../../data/source_catalog_galsim_noise_free.csv', save_dir='../../../data/object_catalog_galsim_noise_free.csv')
