...
def galsim_plot_all_objects(currLens, currObs):
    ...
    # offset between AB and SDSS nmgy
    #if filter is 'z':
    #    filter_AB_offset = -0.02
    #if filter is 'u':
    #    filter_AB_offset = 0.04
    #else:
    #    filter_AB_offset = 0.00
    poisson_noise = desc.slrealizer.return_noise(sky_mag, filter)
    #print('**********HERE', poisson_noise)
    # init galaxy array
...
def galsim_generate_data(currLens, currObs, manual_error=True):
